...
export default function WrapperInfoProyect({ srcImg, title_h1, description, tecnologies }: WrapperInfoProyectProps) {
  return (
    <>
      ...
      <InfoCard mode='proyect' title_h1={title_h1} description={description} tecnologies={tecnologies} />
    </>
  )
}
