...
export const metadata: Metadata = {
  title: 'Portfolio',
  description: 'I am a frontend web developer with demonstrable experience of 1 year working at No Country and Nubedi, where I make modern, responsive, functional and attractive interfaces.',
  generator: 'Next.js',
