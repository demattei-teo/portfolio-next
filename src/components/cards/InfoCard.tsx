...
function InfoCard({ title_h1, title_span, description }: Props) {
  ...
  return (
    <article className='h-full sm:col-start-1 sm:col-end-3 sm:row-start-1  p-4 sm:p-9 grid gap-8 md:gap-12 relative shadow-md bg-blue-50 overflow-hidden rounded-2xl'>
