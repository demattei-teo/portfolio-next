...
function Hero({ title_h1, title_span, description, email, tecnologies, githubUrlProyect, linkProyect }: HeroProps) {
  return (
    <section id='home' className='grid relative gap-5 sm:grid-cols-3 wrapper items-center'>
      ...
      <InfoCard mode='hero' title_h1={title_h1} description={description} />
