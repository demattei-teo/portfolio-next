    ...
    <section id='home' className='grid relative gap-5 sm:grid-cols-3 wrapper items-center'>
      <div className='relative opacity-0 animate-fade-left h-80 sm:col-start-3 sm:col-end-4 sm:h-full w-full'>
        <Image
          ...
          className='object-[0_30%]  sm:object-center object-cover rounded-2xl shadow-sm'
          priority
          fill
          src={fotoCV}
          alt='Teo Demattei'
      ...
      <Image
        ...
        className='rotate-45 animate-wiggle animate-infinite animate-duration-[2000ms] hidden absolute -right-10 bottom-0 -z-20 xl:block '
        width={156}
        height={156}
        sizes='33vw'
      />
